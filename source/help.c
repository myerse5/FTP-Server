...
int command_help (session_info_t *si, char *arg)
{
  ...
  if (arg == NULL) {
    ...
    send_all (si->csfd, (uint8_t *)helpMsgStart, strlen (helpMsgStart));
    send_all (si->csfd, (uint8_t *)row1, strlen (row1));
    send_all (si->csfd, (uint8_t *)row2, strlen (row2));
    send_all (si->csfd, (uint8_t *)row3, strlen (row3));
    send_all (si->csfd, (uint8_t *)row4, strlen (row4));
    send_all (si->csfd, (uint8_t *)row5, strlen (row5));
    send_all (si->csfd, (uint8_t *)row6, strlen (row6));
    send_all (si->csfd, (uint8_t *)row7, strlen (row7));
    send_all (si->csfd, (uint8_t *)row8, strlen (row8));
    send_all (si->csfd, (uint8_t *)helpMsgEnd, strlen (helpMsgEnd));
	...
	send_all (si->csfd, (uint8_t *)helpMsgStart, strlen (helpMsgStart));
	send_all (si->csfd, (uint8_t *)cmdLine, strLength);
	send_all (si->csfd, (uint8_t *)cmdInfo, strlen (cmdInfo));
	send_all (si->csfd, (uint8_t *)helpMsgEnd, strlen (helpMsgEnd));
	...
	send_all (si->csfd, (uint8_t *)argUnrecognized, strlen (argUnrecognized));
